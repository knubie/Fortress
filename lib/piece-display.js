...
module.exports = {
  pin: {
    ...
    'description': (style) => {
      return (<View style={{
        ...
        <Text style={style}>
          Pin an enemy piece. The </Text><Text style={style}>next time it moves, gain  </Text><GoldIcon number={'2'}/><Text style={style}>gold and draw  </Text><CardIcon number={'3'}/><Text style={style}> cards.
        </Text>
      </View>);
    },
    'image': {
  ...
  factory: {
    ...
    'description': (style) => {
      return (<View style={{
        ...
        <Text style={style}>
          <Text style={{fontWeight: 'bold'}}>Produce</Text>: Gain  </Text><GoldIcon number={'1'}/><Text style={style}>gold and draw  </Text><CardIcon number={'1'}/><Text style={style}> card.
        </Text>
      </View>);
    },
    'ability': 'Produce',
  ...
  library: {
    ...
    'description': (style) => {
      return (<View style={{
        ...
        <Text style={style}>
          <Text style={{fontWeight: 'bold'}}>Check Out</Text>: Draw  </Text><CardIcon number={'2'}/><Text style={style}> cards.
        </Text>
      </View>);
    },
    'ability': 'Check Out',
  ...
  'demolition': {
    ...
    description: (style) => {
      return (<View style={{
        ...
        <Text style={style}>Destroy a building, gain </Text><GoldIcon number={'3'}/><Text style={style}> gold.</Text>
      </View>);
    },
    image: {
  ...
  'foreign aid': {
    ...
    description: (style) => {
      return (<View style={{
        ...
        <Text style={style}>Gain </Text><GoldIcon number={'3'}/><Text style={style}> gold.</Text>
      </View>);
    },
    image: {
  ...
  'coffer upgrade': {
    ...
    description: (style) => {
      return (<Text style={[styles.description, style]}>
        Increase your maximum gold storage by 5.
      </Text>);
    },
    'image': {
  ...
  'influence': {
    ...
    description: (style) => {
      return (<Text style={[styles.description, style]}>
        Gain +1 <Text style={{fontWeight: 'bold', color: style.color === '#646464' ? '#353535' : '#D8D8D8',}}>action</Text> on your next turn.
      </Text>);
    },
    'image': {
  ...
  'fortify': {
    ...
    description: (style) => {
      return (<Text style={[styles.description, style]}>
        Grant a piece <Text style={{fontWeight: 'bold', color: style.color === '#646464' ? '#353535' : '#D8D8D8',}}>invincibility</Text> until the end of your opponent's next turn.
      </Text>);
    },
    'image': {
  ...
  steal: {
    ...
    'description': (style) => {
      return (<View style={{
        ...
        <Text style={style}>Steal </Text><GoldIcon number={'1'}/><Text style={style}> from your</Text>
        <Text style={style}>opponent, plus </Text><GoldIcon number={'1'}/><Text style={style}> for </Text>
        <Text style={style}>every Thief you</Text>
        <Text style={style}>have in play.</Text>
      </View>);
    },
    'image': {
  ...
  king: {
    ...
    'description': (style) => {
      return (<View style={{
        ...
        <Text style={style}>
          <Text style={{fontWeight: 'bold'}}>Tax</Text>: +</Text><GoldIcon number={'1'}/><Text style={style}> gold.</Text><Text style={style}>Moves like a standard chess King.
        </Text>
      </View>);
    },
    'ability': 'Tax',
  ...
  'bomber': {
    ...
    'description': (style) => {
      return (<Text style={style}>
        <Text style={{fontWeight: 'bold'}}>Detonate</Text>: destroys adjacent pieces, including friendlys.{'\n'}Destroys any piece that captures it.
      </Text>);
    },
    'image': {
  ...
  'mine': {
    ...
    'description': (style) => {
      return (<View style={{
        ...
        <Text style={style}>
          At the start of your</Text><Text style={style}>turn, gain  </Text><GoldIcon number={'1'}/><Text style={style}> gold.
        </Text>
      </View>);
    },
    'image': {
  ...
  'thief': {
    ...
    'description': (style) => {
      return (<View style={{
        ...
        <GoldIcon number={''}/><Text style={style}> equal to the value
        </Text>
        <Text style={style}>
