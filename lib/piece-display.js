...
module.exports = {
  ...
  steal: {
    ...
    'description': (style) => {
      return (<View style={{
        ...
        <Text style={style}>
          Steal  </Text><GoldIcon number={'2'}/><Text style={style}> gold from your opponent for every Thief you have on the board.
        </Text>
      </View>);
    },
    'image': {
  ...
  'ranger': {
    'displayName': 'Archer',
    'description': o('Moves up to 2 steps diagonally, captures up to 4 steps diagonally without moving.'),
    'image': {
