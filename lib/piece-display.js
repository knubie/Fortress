  ...
  factory: {
    ...
    'description': (style) => {
      return (<View style={{
        ...
        <Text style={style}>
          <Text style={{fontWeight: 'bold'}}>Check Out</Text>: Gain  </Text><GoldIcon number={'1'}/><Text style={style}>gold and draw  </Text><CardIcon number={'1'}/><Text style={style}> card.
        </Text>
      </View>);
    },
    'ability': 'Produce',
  ...
  'demolition': {
    ...
    description: (style) => {
      return (<Text style={[styles.description, style]}>
        Destroy a building, gain 3 gold.
      </Text>);
    },
    image: {
