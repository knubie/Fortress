module.exports = {
  king: {
    'displayName': 'King',
    'description': 'Moves like a normal chess King.',
    'image': {
  ...
  'bomber': {
    'displayName': 'Bomb',
    'description': 'Detonate: destroys every piece in a 1 square radius, including friendly pieces and walls.\nDestroys any piece that captures it.',
    'image': {
  ...
  'mine': {
    'displayName': 'Bank',
    'description': 'Tax: Generates one gold for the kingdom.\nAutomatically generates 1 Gold for the kingdom per turn.\nCannot move.',
    'image': {
