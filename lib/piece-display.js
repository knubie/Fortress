...
module.exports = {
  'fortify': {
    displayName: 'Fortify',
    description: "Grant a piece invincibility until the end of your opponent's next turn.",
    'image': {
  ...
  'church and state': {
    ...
    'description': (
      <Text>
        All friendly <Text style={{fontWeight: 'bold'}}>Pious</Text> pieces gain 1(1/0) movement.
      </Text>),
    'image': {
  ...
  king: {
    'displayName': 'King',
    'description': (<Text><Text style={{fontWeight: 'bold'}}>Tax</Text>: Gain one gold per friendly piece on the board.{'\n'}Moves like a normal chess King.</Text>),
    'ability': 'Tax',
    'image': {
