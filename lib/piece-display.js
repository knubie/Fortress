...
module.exports = {
  'mind control': {
    ...
    description: (style) => {
      return (<Text style={[styles.description, style]}>
        Take control of one of your opponent's pieces.
      </Text>);
    },
    'image': {
  ...
  'church and state': {
    ...
    'description': (style) => {
      return (<View style={{
        ...
        <Text style={style}>
          All friendly <Text style={{fontWeight: 'bold'}}>Pious</Text> pieces gain </Text><MovementTag parlett={{movement: '1/0', distance: '1'}}/><Text style={style}> movement.
        </Text>
      </View>);
    },
    'image': {
  ...
  steal: {
    displayName: 'Steal',
    'description': o('Steal 2 coins from the other player.'),
    'image': {
  ...
  king: {
    ...
    'description': (style) => {
      return (<Text style={style}>
        <Text style={{fontWeight: 'bold'}}>Tax</Text>: Gain one gold per friendly piece on the board.{'\n'}Moves like a standard chess King.
      </Text>);
    },
    'ability': 'Tax',
    'image': {
  ...
  'ranger': {
    'displayName': 'Ranger',
    'description': o('The ranger can capture up to 4 squares diagonally without moving, and can move up to 3 squares diagonally without capturing.'),
    'image': {
